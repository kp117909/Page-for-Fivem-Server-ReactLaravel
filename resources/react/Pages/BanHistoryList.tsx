...
import {Backdrop, Box, CircularProgress, IconButton, InputBase, Paper, Tooltip} from "@mui/material";
import React, { useEffect, useState } from "react";
import { getHistoryBanList } from '../utils';
...
function BanListHistory() {
    ...
    const fetchBanList = async () => {
        setLoading(true);
        try {
            const banList = await getHistoryBanList(); // Zakładam, że masz funkcję getBanList do pobierania listy banów
    ...
    return (
        ...
        <Box display="flex" justifyContent="space-between" alignItems="center">
            <Header title="HISTORIA BANÓW" subtitle="Bany nadane przez administratorów" />
        </Box>
            <Paper
            component="form"
